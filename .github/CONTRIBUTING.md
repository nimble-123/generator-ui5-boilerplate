...
* Open an Issue at https://github.com/nlsltz/generator-ui5-boilerplate/issues
...
* Go to https://github.com/nlsltz/generator-ui5-boilerplate/pulls and open a new pull request with your changes.
...
* Go to the issue tracker and [filter open issues by the `support` label](https://github.com/nlsltz/generator-ui5-boilerplate/issues?q=is%3Aopen+is%3Aissue+label%3Asupport).
...
* Leave a message when closing saying "Cleaning up stale issue. Please reopen or ping us if and when you're ready to resume this. See https://github.com/nlsltz/generator-ui5-boilerplate/blob/latest/.github/CONTRIBUTING.md#clean-up-issues-and-prs for more details."
