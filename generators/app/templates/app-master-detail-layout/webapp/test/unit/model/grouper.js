...
sap.ui.define(
    ['<%= projectNamespaceAMD %>/model/grouper', 'sap/ui/model/resource/ResourceModel', 'jquery.sap.global'],
    function(Grouper, ResourceModel, $) {
        'use strict';

        function createResourceModel() {
            return new ResourceModel({
                bundleUrl: [$.sap.getModulePath('<%= projectNamespace %>'), 'i18n/i18n.properties'].join('/'),
            });
        }
        ...
        QUnit.test('Should group a price lesser equal 20', function(assert) {
            ...
            assert.strictEqual(
                oGrouperReturn.text,
                this._oResourceModel.getResourceBundle().getText('masterGroup1Header1'),
        ...
        QUnit.test('Should group the price', function(assert) {
            ...
            assert.strictEqual(
                oGrouperReturn.text,
                this._oResourceModel.getResourceBundle().getText('masterGroup1Header2'),
