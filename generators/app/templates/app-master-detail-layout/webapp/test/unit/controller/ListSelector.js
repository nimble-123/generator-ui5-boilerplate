...
sap.ui.define(
    ['<%= projectNamespaceAMD %>/controller/ListSelector', 'sap/ui/thirdparty/sinon', 'sap/ui/thirdparty/sinon-qunit'],
    function(ListSelector) {
        ...
        QUnit.test('Should select an Item of the list when it is loaded and the binding contexts match', function(
            assert
        ) {
            // Arrange
            ...
            this.oListSelector._oList = {
                ...
                setSelectedItem: function(oItem) {
                    ...
                    assert.strictEqual(
                        oItem,
                        oListItemToSelect,
                        'Did select the list item with a matching binding context'
                    );
                },
            };
