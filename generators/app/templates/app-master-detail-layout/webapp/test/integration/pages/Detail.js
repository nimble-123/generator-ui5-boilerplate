                ...
                assertions: {
                                ...
                                success: function(aEntitySet) {
                                    ...
                                    this.waitFor({
                                        ...
                                        success: function() {
                                            Opa5.assert.ok(
                                                true,
                                                'was on the first object page with the name ' + sItemName
                                            );
                                        },
                    ...
                    _waitForPageBindingPath: function(sBindingPath) {
                        return this.waitFor({
                            ...
                            matchers: function(oPage) {
                                return (
                                    oPage.getBindingContext() && oPage.getBindingContext().getPath() === sBindingPath
                                );
                            },
                            success: function(oPage) {
                            ...
                            success: function(oList) {
                                ...
                                return this.waitFor({
                                    ...
                                    success: function() {
                                        Opa5.assert.ok(
                                            true,
                                            'The line item list displays ' + iNumberOfItems + ' items'
                                        );
                                    },
