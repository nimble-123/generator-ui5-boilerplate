                ...
                actions: {
                    ...
                    iOpenViewSettingsDialog: function() {
                        return this.waitFor({
                            ...
                            viewName: sViewName,
                            check: function() {
                                var oViewSettingsDialog = Opa5.getWindow()
                                    .sap.ui.getCore()
                    ...
                    iSelectListItemInViewSettingsDialog: function(sListItemTitle) {
                        return this.waitFor({
                            ...
                            actions: new Press(),
                            errorMessage:
                                'Did not find list item with title ' + sListItemTitle + ' in View Settings Dialog.',
                        });
                    },
                                    ...
                                    this.waitFor({
                                        ...
                                        success: function(oList) {
                                            var sCurrentId,
                                                aItemsNotInTheList = aEntityData.filter(function(oObject) {
                                                    return !oList.getItems().some(function(oListItem) {
                                                        return (
                                                            oListItem.getBindingContext().getProperty('ProductID') ===
                                                            oObject.ProductID
                                                        );
                                                    });
                                                });
                                            ...
                                            oCurrentItem.bindingPath =
                                                '/' +
                                                oList.getModel().createKey('Products', {
                ...
                assertions: {
                    ...
                    theListShouldNotContainGroupHeaders: function() {
                        ...
                        return this.waitFor({
                            ...
                            errorMessage:
                                'Master list still contains a group header although grouping has been removed.',
                        });
                    },
                    ...
                    theListShouldBeSortedAscendingOnField: function(sField) {
                        ...
                        return this.waitFor({
                            ...
                            success: function() {
                                Opa5.assert.ok(
                                    true,
                                    "Master list has been sorted correctly for field '" + sField + "'."
                                );
                            },
                    ...
                    theListShouldBeFilteredOnUnitNumberValue: function(iThreshhold, bGreaterThan, oRange) {
                        ...
                        return this.waitFor({
                            ...
                            success: function() {
                                Opa5.assert.ok(
                                    true,
                                    "Master list has been filtered correctly with filter value '" + iThreshhold + "'."
                                );
                            },
                            errorMessage:
                                "Master list has not been filtered correctly with filter value '" + iThreshhold + "'.",
                        });
                    },
                            ...
                            success: function(oList) {
                                ...
                                this.waitFor({
                                    ...
                                    success: function() {
                                        Opa5.assert.ok(
                                            true,
                                            'The master page header displays ' + iExpectedLength + ' items'
                                        );
                                    },
                                    errorMessage:
                        ...
                        this.waitFor({
                            ...
                            success: function(oSelectedItem) {
                                Opa5.assert.strictEqual(
                                    ...
                                    this.getContext().currentItem.title,
