...
sap.ui.define(['sap/ui/test/opaQunit'], function(opaTest) {
    ...
    opaTest('Search for the First object should deliver results that contain the firstObject in the name', function(
        Given,
        When,
        Then
    ) {
    ...
    opaTest(
        'Grouping the master list and filtering it by the object identifier should deliver the initial list',
        function(Given, When, Then) {
            // Action
