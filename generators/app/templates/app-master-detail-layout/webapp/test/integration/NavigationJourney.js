...
sap.ui.define(['sap/ui/test/opaQunit'], function(opaTest) {
    ...
    opaTest(
        'Should start the app with empty hash: the hash should reflect the selection of the first item in the list',
    ...
    opaTest('Detail Page Shows Object Details', function(Given, When, Then) {
        ...
        Then.onTheDetailPage
            .iShouldSeeTheObjectLineItemsList()
    ...
    opaTest(
        'Navigate to an object not on the client: no item should be selected and the object page should be displayed',
        function(Given, When, Then) {
            //Actions
