sap.ui.define(['sap/ui/base/Object', 'sap/m/GroupHeaderListItem'], function(BaseObject, GroupHeaderListItem) {
    'use strict';
    return BaseObject.extend('<%= projectNamespace %>.controller.ListSelector', {
        /**
         * Provides a convenience API for selecting list items. All the functions will wait until the initial load of the a List passed to the instance by the setBoundMasterList
         * function.
         * @class
         * @public
         * @alias <%= projectNamespace %>.controller.ListSelector
         */
         ...
         * @return {<%= projectNamespace %>.model.ListSelector} the list selector object for method chaining
         * @public
         */
