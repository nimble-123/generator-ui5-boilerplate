sap.ui.define([
	"jquery.sap.global",
	"<%= projectNamespaceAMD %>/control/D3Chart",
	...
	return D3Chart.extend("<%= projectNamespace %>.control.D3ComparisonChart", {
		...
		_updateSVG: function(iWidth) {
			...
			var iHighestValue = aData[Object.keys(aData).sort(function(a, b) {
				return aData[a].v - aData[b].v;
			}).pop()].v;
			var iLowestValue = Math.abs(aData[Object.keys(aData).sort(function(a, b) {
