sap.ui.define(['jquery.sap.global', 'sap/ui/core/Control'], function($, Control) {
    'use strict';

    return Control.extend('<%= projectNamespace %>.control.D3Chart', {
        metadata: {
            properties: {
                type: {
                    type: 'string',
        ...
        init: function() {
            ...
            this.setAggregation(
                '_html',
                new sap.ui.core.HTML(this._sContainerId, {
