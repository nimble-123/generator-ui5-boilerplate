sap.ui.define(['jquery.sap.global', '<%= projectNamespaceAMD %>/control/D3Chart', 'sap/ui/thirdparty/d3'], function(
    $,
    D3Chart,
    d3
) {
    ...
    return D3Chart.extend('<%= projectNamespace %>.control.D3PieChart', {
        init: function() {
        ...
        _updateSVG: function(iWidth) {
            var aData = this.getBinding('data')
                .getCurrentContexts()
            ...
            var selTexts = selContainer.selectAll('text').data(aData);
            ...
            selTexts
                ...
                .attr('fill', function() {
                    return sap.ui.core.theming.Parameters.get('sapUiText');
                })
