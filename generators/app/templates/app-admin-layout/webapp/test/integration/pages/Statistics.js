			...
			assertions: {
				...
				iShouldSeeTheCharts: function() {
					if (sChartViewName.search("D3") >= 0) {
						this.waitFor({
							controlType: "<%= projectNamespace %>.control.D3PieChart",
							viewName: sChartViewName,
						...
						this.waitFor({
							controlType: "<%= projectNamespace %>.control.D3ColumnChart",
							viewName: sChartViewName,
							success: function(aCharts) {
						...
						this.waitFor({
							controlType: "<%= projectNamespace %>.control.D3ComparisonChart",
							viewName: sChartViewName,
							success: function(aCharts) {
						...
						this.waitFor({
							controlType: "<%= projectNamespace %>.control.D3Chart",
							viewName: sChartViewName,
							success: function(aCharts) {
